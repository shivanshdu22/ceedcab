        ...
        <div id="total-income">
                <table id="pendingride" class="table rounded " >
						...
						<tr>
							...
							<td class="cyan-text h6"><?php if($udd['status']==1){ echo "Pending";} elseif($udd['status']==2){echo "Canceled";}  else{echo "Completed";}?></td>
							<td><a class="btn btn-primary white-text " href="#" data-id="<?php echo $udd['ride_id'];?>" id="cancel"title="Cancel">Cancel</a> </td>
						</tr>
					    <?php } }?>
						</tbody>
                </table>
